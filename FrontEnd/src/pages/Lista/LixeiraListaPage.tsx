                    ...
                    {listas.length > 0 ? (
                        listas.map((lista) => (
                            lista.Lixeira == true && (
                                <div
                                    key={lista.IdLista}
                                    className={`w-[49.5%] p-4 rounded-xl border-2 border-gray-100 transition-all duration-300 transform hover:scale-105 hover:shadow-lg cursor-pointer hover:border-fuchsia-500`}
                                >
                                                        ...
                                                        <Dialog>
                                                            ...
                                                            <DialogContent className="max-w-lg bg-white/90 rounded-xl shadow-xl p-6 border-none">
                                                                ...
                                                                <DialogFooter className="flex gap-2">
                                                                    ...
                                                                    <DialogClose asChild>
                                                                        <Button
                                                                            className=" hover:cursor-pointer bg-gradient-to-r from-purple-500 to-blue-500 text-white font-semibold rounded-xl shadow hover:from-red-600 hover:to-pink-600 transition-all"
                                                                            onClick={() => {
...
export default LixeiraListasPage;