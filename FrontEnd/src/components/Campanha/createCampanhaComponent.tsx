    ...
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="space-y-2">
              <Label htmlFor="campaign-title" className="font-bold text-xl text-stone-700">Título da Campanha</Label>
              <Input
                id="campaign-title"
                type="text"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4" style={{ minHeight: "500px" }}>
          ...
          <Card className="p-4 flex flex-col border-slate-200 shadow-lg">
            ...
            <textarea
              ...
              className="flex-1 w-full p-3 font-mono text-sm bg-slate-50 border border-slate-300 rounded-lg resize-none 
                focus:outline-none focus:ring-0 focus:border-purple-300 focus:bg-slate-100 
          ...
          <Card className="p-4 flex flex-col border-slate-200 shadow-lg">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-lg font-bold text-stone-700">Preview</h2>
              <span className="text-sm text-slate-500">Atualização em tempo real</span>
            </div>
            <div className="flex-1 border border-slate-300 rounded-lg overflow-hidden shadow-inner">
              <iframe
                srcDoc={htmlCode}
